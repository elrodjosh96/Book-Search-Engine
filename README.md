...
![MainPage](./assets/booksearchmainpage.png)
![Saved Books](./assets/savedbooks.png)

## Description

I was tasked with taking an already existing RESTful API Google Book Search Engine app and refractoring it to implement an Apollo Server and use GraphQL based on the following User Story and Acceptance Criteria.
